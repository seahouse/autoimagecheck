...
namespace WindowsFormsApplication1
{
  public partial class Form1 : Form
  {
    ...
    private List<double> _x1List;
    private List<double> _x2List;
    private List<double> _x3List;
    private List<double> _x4List;
    private List<double> _y1List;
    private List<double> _y2List;
    private List<double> _y3List;
    private List<double> _y4List;
    #endregion
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      chart.Series[0].Name = "t2";

      _x1List = listX_B_Left;
      _y1List = listY_B_Left;
      //chart.Series[0].Points.DataBindY(listY_A_Right);
    }
    ...
    private void button2_Click(object sender, EventArgs e)
    {
      ...
      chart.Series[1].Points.DataBindXY(listX_B_Left, listY_B_Left);
      chart.Series[1].Name = "B301GF_CR10-LE";
    ...
    private void btnCalc_Click(object sender, EventArgs e)
    {
      ...
      {
        System.Windows.Forms.DataVisualization.Charting.DataPoint dp0 = chart.Series[0].Points[i];
        ...
        {
          System.Windows.Forms.DataVisualization.Charting.DataPoint dp1 = chart.Series[1].Points[j];
          double x1 = dp1.XValue;
          double y1 = dp1.YValues[0];

          double length = Math.Sqrt(Math.Pow(x1 - x0, 2) + Math.Pow(y1 - y0, 2));
          if (mixLength == 0.0)
            mixLength = length;
          else if (mixLength > length)
            mixLength = length;
        }

        if (maxLength == 0.0)
          maxLength = mixLength;
        else if (maxLength < mixLength)
          maxLength = mixLength;
      }
    }
  }
